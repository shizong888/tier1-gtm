...
import { getAllDocuments } from '@/lib/convex-server';
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const firstDoc = documents.sort((a, b) => a.order - b.order)[0];

  return {
    title: `${firstDoc?.title || 'Home'} | Tier 1 GTM Strategy`,
    description: firstDoc ? `Tier 1 Go-To-Market Strategy: ${firstDoc.title}` : 'Tier 1 Go-To-Market Strategy',
  };
}
